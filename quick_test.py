"""
Quick test to verify all imports work correctly (Fixed Version)
"""
...
def test_basic_functionality():
    ...
    try:
        ...
        from TinyPeLLMTokenizer import TinyPeLLMTokenizer
        from TinyPeLLMPipeline import register_tiny_pellm
...
def main():
    """Run quick tests"""
    print("🚀 Quick Test for TinyPeLLM (Fixed)")
    print("=" * 40)
